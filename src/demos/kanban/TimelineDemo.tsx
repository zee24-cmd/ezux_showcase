                ...
                <EzKanban
                    ...
                    slots={{
                        cardEditor: ({ isOpen, card, onClose, onSave, columns }) => {
                            ...
                            // Only run initialization when modal first opens (isOpen changes to true)
                            ...
                            useEffect(() => {
                                if (isOpen && !isInitialized.current) {
                                    ...
                                    // Initialize title, description and column from the card or defaults
                                    setLocalEditedTitle(card?.title || '');
                                    setLocalEditedDescription(card?.description || '');
                                    // For new cards or cards without columnId, use the first column
